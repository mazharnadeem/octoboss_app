...
import '../Customer/customer_issue_list_screen_api.dart';


class OctobossChatScreen extends StatefulWidget {
  const OctobossChatScreen({Key? key}) : super(key: key);
...
class _OctobossChatScreenState extends State<OctobossChatScreen> {
  ...
  Future<File?> openFile(String url,String fileName) async {
    ...
    // await dio.download(imgUrl, "${dir.path}.pdf",
    //     onReceiveProgress: ((count, total) {
    //       print("Count:$count, Total: $total");
    //       setState(() {
    //         downloading = true;
    ...
    try{
      ...
      if(response.statusCode==201){
        ...
        if(data2['data']['approved'].toString().toLowerCase()=='approved'){
          ...
          updateApprovedOffers(get_receiverId.toString(),user_details['data']['id'],'approved', offerId,time: time,date: date);
          updateApprovedOffers(user_details['data']['id'],get_receiverId.toString(),'approved', offerId,time: time,date: date);
          }
  ...
  updateApprovedOffers(var sender,var receiver,var status ,var chatId,{var time,var date}) async{
    try{
      var data={
        'sender_id':sender,
  ...
  checkVisibilty_Details(){
    ...
    if(approved_offers['approved']=='approved' && approved_offers['sender_id']==get_receiverId.toString() && approved_offers['receiver_id']== user_details['data']['id'] ){
      setState(() {
        approved_offers;
      });
      return true;
  ...
  Widget build(BuildContext context) {
    approvedOfferList(get_receiverId.toString(),onlyforOffer: 'offer');
            ...
            Card(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Visibility(
                    // visible: checkVisibilty_Details(),
                                        ...
                                        children: [
                                          Row(children: [
                                            CircleAvatar(
                                              radius: 20,
                                              child: IconButton(
                                                icon: Icon((isPlaying && audioClick_octo==messages[index]['id'])?Icons.pause:Icons.play_arrow),
                                                onPressed: () async {
                                                  audioClick_octo=messages[index]['id'];
                                                  if(isPlaying){
                                            ...
                                            (audioClick_octo==messages[index]['id'])?Slider(
                                                min:0,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              (audioClick_octo==messages[index]['id'])?Text('${position.inSeconds.toString()} : ${position.inMinutes.toString()}'):Text('0 : 0'),
                                              SizedBox(width: Get.size.width*0.25 ,),
                                              (audioClick_octo==messages[index]['id'])?Text('${(duration-position).inSeconds} : ${position.inMinutes.toString()}'):Text('0 : 0'),
                                            ],),
                                          SizedBox(height: 5,),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        if(messages[index]['message_type']=='document'){
                          ...
                          return x==y?Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  docClick_octo=messages[index]['id'];
                                            ...
                                            Row(
                                              children: [
                                                Container(
                                                    ...
                                                    child: Text('$fileName')),
                                                SizedBox(width: 30,),
                                                (downloading==false && docClick_octo==messages[index]['id'])?Column(children: [
                                            ...
                                            children: [
                                              ...
                                              Container(width: Get.size.width*0.6,
                                                child: TextFormField(
                                                  enabled: false,
                                                  decoration: InputDecoration(
                                                    hintText: messages[index]['location'],
                                                    contentPadding: EdgeInsets.symmetric(
                                                        vertical: 10.0, horizontal: 20.0),
                                                    border: OutlineInputBorder(
                                                      borderRadius: BorderRadius.all(Radius.circular(8.0)),
                          ...
                          children: [
                            MaterialButton(
                              ...
                              onPressed: () {
                                ...
                                // NotificationService().showNotification(1, 'Alert', "Kindly, complete your offer.", 5,pickedTime!.hour,pickedTime!.minute);
